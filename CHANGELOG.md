...
- batch relation queries, race conditions, navigation edge cases <details><summary>Details</summary>
...
- consolidate data under ~/.config/rfc, improve sync UX <details><summary>Details</summary>
...
- remove outer frame, fix keymaps, improve search highlights and sync output <details><summary>Details</summary>
  - Remove Box border from search and reader screens, use plain Column
  - Gate vim keys (j/k/g/G/h/l//) behind keymap check so they don't fire in emacs mode
