...
- Adopt weew 0.2.0 patterns, add keymap toggle, remove search limit <details><summary>Details</summary>
  - Delegate text editing in search input and content search to TextInput.handleKey
  - Replace manual result list rendering with VirtualList (virtualized + scrollbar)
